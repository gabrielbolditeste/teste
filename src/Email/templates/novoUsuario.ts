export const templateNovoUsuario = (senha: string) => {
  ...
  <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%" style="max-width:37.5em;margin:0 auto;padding:20px 0 48px;width:560px">
    <tr style="width:100%">
      <td><img alt="Linear" src="https://i.ibb.co/KLvf9xD/logo.jpg" width="120" height="120" style="display:block;outline:none;border:none;text-decoration:none;border-radius:21px;width:42px;height:42px" />
        <h1 style="font-size:24px;letter-spacing:-0.5px;line-height:1.3;font-weight:400;color:#484848;padding:17px 0 0">Seja bem-vindo a KMB controle de serviços</h1>
        
        <p style="font-size:15px;line-height:1.4;margin:0 0 15px;color:#3c4149">Faça login com seu E-mail e sua senha provisoria:</p><code style="font-family:monospace;font-weight:700;padding:1px 4px;background-color:#dfe1e4;letter-spacing:-0.3px;font-size:21px;border-radius:4px;color:#3c4149">${senha}</code>
